...
- Verified result on 2026-06-15: 278 unittests pass, compileall passes, source GUI startup smoke passes, release audit passes, synthetic scan/cache smoke passes, root import smoke and cross-CWD import smoke pass, `tools/run_checks.ps1` exits 0.
